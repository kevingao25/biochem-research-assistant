...
class AskRequest(BaseModel):
    ...
    use_hybrid: bool = Field(True, description="Use hybrid search (BM25 + dense); falls back to BM25 if Jina is unreachable")
    categories: Optional[List[str]] = Field(None, description="Filter by arXiv categories (e.g. ['q-bio.BM', 'q-bio.GN']); not yet implemented in search")
